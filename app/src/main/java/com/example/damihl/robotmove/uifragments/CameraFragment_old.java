...
import com.example.damihl.robotmove.camera.ColorBlobDetector;
...
public class CameraFragment_old extends android.support.v4.app.Fragment implements View.OnTouchListener, CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private BaseLoaderCallback mLoaderCallback = new BaseLoaderCallback(MainActivity.getInstance()) {
        @Override
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(CameraFragment_old.this);
                } break;
                default:
                {
